...
class Service(models.Model):
    ...
    seo_desc = models.CharField(max_length=160,blank=True,null=True,unique=True,help_text="This must not be more than 160 characters and must relate to Service")
